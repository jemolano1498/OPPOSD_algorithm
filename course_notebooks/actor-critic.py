...
# plt.xlabel('environment interaction')  # ENvironment interactions
# plt.ylabel('Episode reward')
# # plt.legend(['RL', 'RL+Advantage', 'AC'])
# # plt.legend()
# plt.title('Cart-pole environment')
# plt.savefig('cartpole_comp_rl_alg.pdf')
#
# for exp in online_experiments:
#     # Smooth curves
#     np.savetxt("CARTPOLE_RL_%s_EXPERIMENT.csv"%(exp['model']), exp['experiment'].episode_returns, delimiter=",")
